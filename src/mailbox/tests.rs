use super::{
    ...
    parse_next_day_epoch_ms, parse_start_of_day_epoch_ms, search, sync_run,
};
use crate::auth;
...
fn parses_yyyy_mm_dd_date_bounds() {
    ...
    assert_eq!(parse_next_day_epoch_ms("1970-01-01").unwrap(), 86_400_000);
...
async fn search_migrates_schema_v2_store_before_querying_mailbox_tables() {
    ...
    assert_eq!(store_report.schema_version, Some(3));
