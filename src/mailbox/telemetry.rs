...
impl SyncRunContext {
    ...
    pub(crate) fn failure_outcome_input(
        ...
        store::mailbox::SyncRunOutcomeInput {
            ...
            messages_upserted: usize_to_i64(failure.messages_upserted),
            messages_deleted: usize_to_i64(failure.messages_deleted),
            labels_synced: usize_to_i64(failure.labels_synced),
            checkpoint_reused_pages: usize_to_i64(failure.checkpoint_reused_pages),
            checkpoint_reused_messages_upserted: usize_to_i64(
                failure.checkpoint_reused_messages_upserted,
            ),
