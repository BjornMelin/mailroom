...
use cli::{
    ...
    SyncPerfCommand, SyncProfileArg, SyncRunArgs, TriageBucketArg, TriageCommand, WorkflowCommand,
...
mod tests {
    use super::{
        ...
        resolve_draft_body_input, resolve_snooze_until, resolve_sync_run_options,
    };
